                    ...
                    <div class="col-md-9 single-grid">
                        <div clas="single-top">
                            <div class="single-left">
                                <div class="flexslider">
                                    <ul class="slides">
                                        ...
                                        <li data-thumb="{{ asset($productDetails->productDetails_image) }}">
                                            <div class="thumb-image"> <img src="{{ asset($productDetails->product_image) }}" data-imagezoom="true" class="img-responsive"> </div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="single-right simpleCart_shelfItem">
                                ...
                                <p class="price item_price">TK. {{ $productDetails->product_price }}</p>
                    ...
                    <div class="col-md-3 single-grid1">
                        ...
                        <div class="recent-grids">
                            <div class="recent-left">
                                <a href="single.html"><img class="img-responsive " src="" alt=""></a>
                            </div>
